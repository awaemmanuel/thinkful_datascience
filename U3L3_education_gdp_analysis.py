...
def create_table_education():
    ...
    with con:
        ...
        cur.execute("CREATE TABLE education_life_info (Country TEXT PRIMARY KEY, Year INT, Total_School_Time INT,  Male_Expectancy INT, Female_Expectancy INT);")
...
def create_table_gdp():
    ...
    with con:
        ...
        cur.execute('CREATE TABLE worldbank_gdp_data (Country REAL, GDP_1999 NUMERIC, GDP_2000 NUMERIC, GDP_2001 NUMERIC, GDP_2002 NUMERIC, GDP_2003 NUMERIC, GDP_2004 NUMERIC, GDP_2005 NUMERIC, GDP_2006 NUMERIC, GDP_2007 NUMERIC, GDP_2008 NUMERIC, GDP_2009 NUMERIC, GDP_2010 NUMERIC);')
...
def get_cleaned_data_from_table(soup):
    ...
    clean_data = [d for d in all_data if len(d) == 25] # the length of empty field is 7 and filled 25
    return clean_data
...
def bulk_insert_into_db_education(df):
    ...
    # Prepared SQL
    sql = "INSERT INTO education_life_info (Country, Year, Total_School_Time, Male_Expectancy, Female_Expectancy) VALUES (?,?,?,?,?)"
...
def bulk_insert_into_db_gdb(min_year, max_year):
    ...
    with open('world_bank_gdp_data/9612cab5-6177-41d5-a04f-55d22c4169b7_v2.csv') as inputFile:
        ...
        for line in inputReader:
            if line:
                with con:
                    cur.execute('INSERT INTO worldbank_gdp_data (Country, GDP_1999, GDP_2000, GDP_2001, GDP_2002, GDP_2003, GDP_2004, GDP_2005, GDP_2006, GDP_2007, GDP_2008, GDP_2009, GDP_2010) VALUES ("' + line[country_idx] + '","' + '","'.join(line[min_year_idx : (max_year_idx + 1)]) + '");')
